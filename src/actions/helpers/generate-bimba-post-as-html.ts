...
Утримуйся від того щоб писати в заголовку очевидні речі типу ШОК! і подібне, тільки в разі якщо це дійсно шокуюча новина.
Теги обов'язково напиши у форматі ПаскальКейсі. В тегах Заборонено використовувати нижні підкреслення, дефіс, крапки, коми, апострофи та інші спеціальні символи
